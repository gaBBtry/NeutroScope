...
def main():
    ...
    cmd = [
        ...
        "--hidden-import=PyQt6.QtCore", # Imports cachés nécessaires
        ...
        "--hidden-import=numpy",
        "--hidden-import=scipy",
        "--hidden-import=src.controller.reactor_controller",  # Modules src
        "--hidden-import=src.model.reactor_model",
        "--hidden-import=src.model.config",
        "--hidden-import=src.gui.main_window",
        "--hidden-import=src.gui.visualization",
